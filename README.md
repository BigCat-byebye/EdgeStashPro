...
| D1 Database | `D1_DB` | 保存搜索索引、收藏、最近访问、TXT 书签、分享链接、统计、用户路径权限和文件任务 |
...
TXT 书签直接复用现有 D1，主题和字号偏好保存在浏览器本地；这些功能不会创建 Durable Objects、Cron Trigger、Queue、Workflow 或其他 Cloudflare 资源。
